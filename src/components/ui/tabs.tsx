...
export const TabsContent = <T extends ValidComponent = "div">(
    ...
    return (
        <TabsPrimitive.Content
            class={cn(
                "focus-visible:ring-ring mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-offset-2",
                local.class,
            )}
            {...rest}
        />
...
export const TabsTrigger = <T extends ValidComponent = "button">(
    ...
    return (
        <TabsPrimitive.Trigger
            class={cn(
                "focus-visible:ring-ring data-[selected]:text-foreground inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium ring-offset-background transition-shadow focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[selected]:bg-background data-[selected]:shadow",
                local.class,
            )}
            {...rest}
        />
