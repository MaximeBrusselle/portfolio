    ...
    return (
        <TooltipPrimitive.Portal>
            <TooltipPrimitive.Content
                class={cn(
                    "text-primary-foreground z-50 overflow-hidden rounded-md bg-primary px-3 py-1.5 text-xs data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0 data-[closed]:zoom-out-95 data-[expanded]:zoom-in-95",
                    local.class,
                )}
                {...rest}
            />
